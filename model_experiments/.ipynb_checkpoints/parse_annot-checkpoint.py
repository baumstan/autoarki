#Source of functions: https://aws.amazon.com/blogs/machine-learning/streamlining-data-labeling-for-yolo-object-detection-in-amazon-sagemaker-ground-truth/
# Note custom changes were made 2022-02 Kineret 
...
def parse_gt_output(manifest_path, job_name):
    ...
    with fs.open(manifest_path, 'rb') as fin:    
        annot_list = []
